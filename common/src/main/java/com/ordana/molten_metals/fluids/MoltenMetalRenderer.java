...
public class MoltenMetalRenderer extends ModFluidRenderProperties {
    ...
    public MoltenMetalRenderer(ResourceLocation still, ResourceLocation flowing, int tint, ResourceLocation overlay, ResourceLocation renderOverlay, Vec3 fogColor) {
